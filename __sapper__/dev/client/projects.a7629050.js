...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-pqdgfm");
			add_location(h10, file, 97, 4, 2900);
			attr_dev(div0, "class", "projectTitle svelte-pqdgfm");
			add_location(div0, file, 96, 3, 2869);
			attr_dev(p0, "class", "svelte-pqdgfm");
			add_location(p0, file, 100, 4, 2967);
			attr_dev(p1, "class", "svelte-pqdgfm");
			add_location(p1, file, 103, 4, 3043);
			attr_dev(div1, "class", "projectBody svelte-pqdgfm");
			add_location(div1, file, 99, 3, 2937);
			attr_dev(div2, "class", "projectTile svelte-pqdgfm");
			add_location(div2, file, 95, 2, 2840);
			attr_dev(a0, "href", "This Website");
			attr_dev(a0, "onclick", "return false");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-pqdgfm");
			add_location(a0, file, 94, 1, 2775);
			attr_dev(h11, "class", "svelte-pqdgfm");
			add_location(h11, file, 114, 4, 3283);
			attr_dev(div3, "class", "projectTitle svelte-pqdgfm");
			add_location(div3, file, 113, 3, 3252);
			attr_dev(p2, "class", "svelte-pqdgfm");
			add_location(p2, file, 117, 4, 3342);
			attr_dev(p3, "class", "svelte-pqdgfm");
			add_location(p3, file, 120, 4, 3387);
			attr_dev(p4, "class", "svelte-pqdgfm");
			add_location(p4, file, 124, 4, 3525);
			attr_dev(div4, "class", "projectBody svelte-pqdgfm");
			add_location(div4, file, 116, 3, 3312);
			attr_dev(div5, "class", "projectTile svelte-pqdgfm");
			add_location(div5, file, 112, 2, 3223);
			attr_dev(a1, "href", "https://coopscodes.github.io/resume/");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-pqdgfm");
			add_location(a1, file, 111, 1, 3157);
			attr_dev(h12, "class", "svelte-pqdgfm");
			add_location(h12, file, 134, 4, 3721);
			attr_dev(div6, "class", "projectTitle svelte-pqdgfm");
			add_location(div6, file, 133, 3, 3690);
			attr_dev(p5, "class", "svelte-pqdgfm");
			add_location(p5, file, 137, 4, 3800);
			attr_dev(p6, "class", "svelte-pqdgfm");
			add_location(p6, file, 144, 4, 4014);
			attr_dev(div7, "class", "projectBody svelte-pqdgfm");
			add_location(div7, file, 136, 3, 3770);
			attr_dev(div8, "class", "projectTile svelte-pqdgfm");
			add_location(div8, file, 132, 2, 3661);
			attr_dev(a2, "href", "https://github.com/CoopsCodes/CSharpRobot");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-pqdgfm");
			add_location(a2, file, 131, 1, 3590);
			attr_dev(h13, "class", "svelte-pqdgfm");
			add_location(h13, file, 154, 4, 4207);
			attr_dev(div9, "class", "projectTitle svelte-pqdgfm");
			add_location(div9, file, 153, 3, 4176);
			attr_dev(p7, "class", "svelte-pqdgfm");
			add_location(p7, file, 157, 4, 4272);
			attr_dev(p8, "class", "svelte-pqdgfm");
			add_location(p8, file, 160, 4, 4347);
			attr_dev(p9, "class", "svelte-pqdgfm");
			add_location(p9, file, 163, 4, 4414);
			attr_dev(div10, "class", "projectBody svelte-pqdgfm");
			add_location(div10, file, 156, 3, 4242);
			attr_dev(div11, "class", "projectTile svelte-pqdgfm");
			add_location(div11, file, 152, 2, 4147);
			attr_dev(a3, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-pqdgfm");
			add_location(a3, file, 151, 1, 4074);
			attr_dev(h14, "class", "svelte-pqdgfm");
			add_location(h14, file, 173, 4, 4600);
			attr_dev(div12, "class", "projectTitle svelte-pqdgfm");
			add_location(div12, file, 172, 3, 4569);
			attr_dev(p10, "class", "svelte-pqdgfm");
			add_location(p10, file, 176, 4, 4659);
			attr_dev(p11, "class", "svelte-pqdgfm");
			add_location(p11, file, 180, 4, 4789);
			attr_dev(div13, "class", "projectBody svelte-pqdgfm");
			add_location(div13, file, 175, 3, 4629);
			attr_dev(div14, "class", "projectTile svelte-pqdgfm");
			add_location(div14, file, 171, 2, 4540);
			attr_dev(a4, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-pqdgfm");
			add_location(a4, file, 170, 1, 4474);
			attr_dev(h15, "class", "svelte-pqdgfm");
			add_location(h15, file, 193, 4, 5006);
			attr_dev(div15, "class", "projectTitle svelte-pqdgfm");
			add_location(div15, file, 192, 3, 4975);
			attr_dev(p12, "class", "svelte-pqdgfm");
			add_location(p12, file, 196, 4, 5090);
			attr_dev(p13, "class", "svelte-pqdgfm");
			add_location(p13, file, 200, 4, 5196);
			attr_dev(div16, "class", "projectBody svelte-pqdgfm");
			add_location(div16, file, 195, 3, 5060);
			attr_dev(div17, "class", "projectTile svelte-pqdgfm");
			add_location(div17, file, 191, 2, 4946);
			attr_dev(a5, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a5, "target", "_blank");
			attr_dev(a5, "class", "svelte-pqdgfm");
			add_location(a5, file, 187, 1, 4849);
			attr_dev(body, "class", "projectsContainer svelte-pqdgfm");
			add_location(body, file, 72, 0, 2252);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
