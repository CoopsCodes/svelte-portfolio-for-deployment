...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-topta4");
			add_location(h10, file, 90, 4, 2584);
			attr_dev(div0, "class", "projectTitle svelte-topta4");
			add_location(div0, file, 89, 3, 2553);
			attr_dev(p0, "class", "svelte-topta4");
			add_location(p0, file, 93, 4, 2649);
			attr_dev(p1, "class", "svelte-topta4");
			add_location(p1, file, 96, 4, 2731);
			attr_dev(div1, "class", "projectBody svelte-topta4");
			add_location(div1, file, 92, 3, 2619);
			attr_dev(div2, "class", "projectTile svelte-topta4");
			add_location(div2, file, 88, 2, 2524);
			attr_dev(a0, "href", "This Website");
			attr_dev(a0, "onclick", "return false");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-topta4");
			add_location(a0, file, 87, 1, 2459);
			attr_dev(h11, "class", "svelte-topta4");
			add_location(h11, file, 107, 4, 2971);
			attr_dev(div3, "class", "projectTitle svelte-topta4");
			add_location(div3, file, 106, 3, 2940);
			attr_dev(p2, "class", "svelte-topta4");
			add_location(p2, file, 110, 4, 3030);
			attr_dev(p3, "class", "svelte-topta4");
			add_location(p3, file, 113, 4, 3075);
			attr_dev(p4, "class", "svelte-topta4");
			add_location(p4, file, 117, 4, 3213);
			attr_dev(div4, "class", "projectBody svelte-topta4");
			add_location(div4, file, 109, 3, 3000);
			attr_dev(div5, "class", "projectTile svelte-topta4");
			add_location(div5, file, 105, 2, 2911);
			attr_dev(a1, "href", "https://coopscodes.github.io/resume/");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-topta4");
			add_location(a1, file, 104, 1, 2845);
			attr_dev(h12, "class", "svelte-topta4");
			add_location(h12, file, 127, 4, 3409);
			attr_dev(div6, "class", "projectTitle svelte-topta4");
			add_location(div6, file, 126, 3, 3378);
			attr_dev(p5, "class", "svelte-topta4");
			add_location(p5, file, 130, 4, 3488);
			attr_dev(p6, "class", "svelte-topta4");
			add_location(p6, file, 137, 4, 3702);
			attr_dev(div7, "class", "projectBody svelte-topta4");
			add_location(div7, file, 129, 3, 3458);
			attr_dev(div8, "class", "projectTile svelte-topta4");
			add_location(div8, file, 125, 2, 3349);
			attr_dev(a2, "href", "https://github.com/CoopsCodes/CSharpRobot");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-topta4");
			add_location(a2, file, 124, 1, 3278);
			attr_dev(h13, "class", "svelte-topta4");
			add_location(h13, file, 147, 4, 3895);
			attr_dev(div9, "class", "projectTitle svelte-topta4");
			add_location(div9, file, 146, 3, 3864);
			attr_dev(p7, "class", "svelte-topta4");
			add_location(p7, file, 150, 4, 3960);
			attr_dev(p8, "class", "svelte-topta4");
			add_location(p8, file, 153, 4, 4035);
			attr_dev(p9, "class", "svelte-topta4");
			add_location(p9, file, 156, 4, 4102);
			attr_dev(div10, "class", "projectBody svelte-topta4");
			add_location(div10, file, 149, 3, 3930);
			attr_dev(div11, "class", "projectTile svelte-topta4");
			add_location(div11, file, 145, 2, 3835);
			attr_dev(a3, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-topta4");
			add_location(a3, file, 144, 1, 3762);
			attr_dev(h14, "class", "svelte-topta4");
			add_location(h14, file, 166, 4, 4288);
			attr_dev(div12, "class", "projectTitle svelte-topta4");
			add_location(div12, file, 165, 3, 4257);
			attr_dev(p10, "class", "svelte-topta4");
			add_location(p10, file, 169, 4, 4347);
			attr_dev(p11, "class", "svelte-topta4");
			add_location(p11, file, 173, 4, 4477);
			attr_dev(div13, "class", "projectBody svelte-topta4");
			add_location(div13, file, 168, 3, 4317);
			attr_dev(div14, "class", "projectTile svelte-topta4");
			add_location(div14, file, 164, 2, 4228);
			attr_dev(a4, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-topta4");
			add_location(a4, file, 163, 1, 4162);
			attr_dev(h15, "class", "svelte-topta4");
			add_location(h15, file, 186, 4, 4694);
			attr_dev(div15, "class", "projectTitle svelte-topta4");
			add_location(div15, file, 185, 3, 4663);
			attr_dev(p12, "class", "svelte-topta4");
			add_location(p12, file, 189, 4, 4778);
			attr_dev(p13, "class", "svelte-topta4");
			add_location(p13, file, 193, 4, 4884);
			attr_dev(div16, "class", "projectBody svelte-topta4");
			add_location(div16, file, 188, 3, 4748);
			attr_dev(div17, "class", "projectTile svelte-topta4");
			add_location(div17, file, 184, 2, 4634);
			attr_dev(a5, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a5, "target", "_blank");
			attr_dev(a5, "class", "svelte-topta4");
			add_location(a5, file, 180, 1, 4537);
			attr_dev(body, "class", "projectsContainer svelte-topta4");
			add_location(body, file, 65, 0, 1936);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
