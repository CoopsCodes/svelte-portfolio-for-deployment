...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-1mwmeqp");
			add_location(h10, file, 91, 4, 2640);
			attr_dev(div0, "class", "projectTitle svelte-1mwmeqp");
			add_location(div0, file, 90, 3, 2609);
			attr_dev(p0, "class", "svelte-1mwmeqp");
			add_location(p0, file, 94, 4, 2705);
			attr_dev(p1, "class", "svelte-1mwmeqp");
			add_location(p1, file, 97, 4, 2787);
			attr_dev(div1, "class", "projectBody svelte-1mwmeqp");
			add_location(div1, file, 93, 3, 2675);
			attr_dev(div2, "class", "projectTile svelte-1mwmeqp");
			add_location(div2, file, 89, 2, 2580);
			attr_dev(a0, "href", "This Website");
			attr_dev(a0, "onclick", "return false");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-1mwmeqp");
			add_location(a0, file, 88, 1, 2515);
			attr_dev(h11, "class", "svelte-1mwmeqp");
			add_location(h11, file, 108, 4, 3027);
			attr_dev(div3, "class", "projectTitle svelte-1mwmeqp");
			add_location(div3, file, 107, 3, 2996);
			attr_dev(p2, "class", "svelte-1mwmeqp");
			add_location(p2, file, 111, 4, 3086);
			attr_dev(p3, "class", "svelte-1mwmeqp");
			add_location(p3, file, 114, 4, 3131);
			attr_dev(p4, "class", "svelte-1mwmeqp");
			add_location(p4, file, 118, 4, 3269);
			attr_dev(div4, "class", "projectBody svelte-1mwmeqp");
			add_location(div4, file, 110, 3, 3056);
			attr_dev(div5, "class", "projectTile svelte-1mwmeqp");
			add_location(div5, file, 106, 2, 2967);
			attr_dev(a1, "href", "https://coopscodes.github.io/resume/");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-1mwmeqp");
			add_location(a1, file, 105, 1, 2901);
			attr_dev(h12, "class", "svelte-1mwmeqp");
			add_location(h12, file, 128, 4, 3465);
			attr_dev(div6, "class", "projectTitle svelte-1mwmeqp");
			add_location(div6, file, 127, 3, 3434);
			attr_dev(p5, "class", "svelte-1mwmeqp");
			add_location(p5, file, 131, 4, 3544);
			attr_dev(p6, "class", "svelte-1mwmeqp");
			add_location(p6, file, 138, 4, 3758);
			attr_dev(div7, "class", "projectBody svelte-1mwmeqp");
			add_location(div7, file, 130, 3, 3514);
			attr_dev(div8, "class", "projectTile svelte-1mwmeqp");
			add_location(div8, file, 126, 2, 3405);
			attr_dev(a2, "href", "https://github.com/CoopsCodes/CSharpRobot");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-1mwmeqp");
			add_location(a2, file, 125, 1, 3334);
			attr_dev(h13, "class", "svelte-1mwmeqp");
			add_location(h13, file, 148, 4, 3951);
			attr_dev(div9, "class", "projectTitle svelte-1mwmeqp");
			add_location(div9, file, 147, 3, 3920);
			attr_dev(p7, "class", "svelte-1mwmeqp");
			add_location(p7, file, 151, 4, 4016);
			attr_dev(p8, "class", "svelte-1mwmeqp");
			add_location(p8, file, 154, 4, 4091);
			attr_dev(p9, "class", "svelte-1mwmeqp");
			add_location(p9, file, 157, 4, 4158);
			attr_dev(div10, "class", "projectBody svelte-1mwmeqp");
			add_location(div10, file, 150, 3, 3986);
			attr_dev(div11, "class", "projectTile svelte-1mwmeqp");
			add_location(div11, file, 146, 2, 3891);
			attr_dev(a3, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-1mwmeqp");
			add_location(a3, file, 145, 1, 3818);
			attr_dev(h14, "class", "svelte-1mwmeqp");
			add_location(h14, file, 167, 4, 4344);
			attr_dev(div12, "class", "projectTitle svelte-1mwmeqp");
			add_location(div12, file, 166, 3, 4313);
			attr_dev(p10, "class", "svelte-1mwmeqp");
			add_location(p10, file, 170, 4, 4403);
			attr_dev(p11, "class", "svelte-1mwmeqp");
			add_location(p11, file, 174, 4, 4533);
			attr_dev(div13, "class", "projectBody svelte-1mwmeqp");
			add_location(div13, file, 169, 3, 4373);
			attr_dev(div14, "class", "projectTile svelte-1mwmeqp");
			add_location(div14, file, 165, 2, 4284);
			attr_dev(a4, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-1mwmeqp");
			add_location(a4, file, 164, 1, 4218);
			attr_dev(h15, "class", "svelte-1mwmeqp");
			add_location(h15, file, 187, 4, 4750);
			attr_dev(div15, "class", "projectTitle svelte-1mwmeqp");
			add_location(div15, file, 186, 3, 4719);
			attr_dev(p12, "class", "svelte-1mwmeqp");
			add_location(p12, file, 190, 4, 4834);
			attr_dev(p13, "class", "svelte-1mwmeqp");
			add_location(p13, file, 194, 4, 4940);
			attr_dev(div16, "class", "projectBody svelte-1mwmeqp");
			add_location(div16, file, 189, 3, 4804);
			attr_dev(div17, "class", "projectTile svelte-1mwmeqp");
			add_location(div17, file, 185, 2, 4690);
			attr_dev(a5, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a5, "target", "_blank");
			attr_dev(a5, "class", "svelte-1mwmeqp");
			add_location(a5, file, 181, 1, 4593);
			attr_dev(body, "class", "projectsContainer svelte-1mwmeqp");
			add_location(body, file, 66, 0, 1992);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
