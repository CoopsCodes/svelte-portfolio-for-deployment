...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-1y6sxs9");
			add_location(h10, file, 92, 4, 2690);
			attr_dev(div0, "class", "projectTitle svelte-1y6sxs9");
			add_location(div0, file, 91, 3, 2659);
			attr_dev(p0, "class", "svelte-1y6sxs9");
			add_location(p0, file, 95, 4, 2755);
			attr_dev(p1, "class", "svelte-1y6sxs9");
			add_location(p1, file, 98, 4, 2837);
			attr_dev(div1, "class", "projectBody svelte-1y6sxs9");
			add_location(div1, file, 94, 3, 2725);
			attr_dev(div2, "class", "projectTile svelte-1y6sxs9");
			add_location(div2, file, 90, 2, 2630);
			attr_dev(a0, "href", "This Website");
			attr_dev(a0, "onclick", "return false");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-1y6sxs9");
			add_location(a0, file, 89, 1, 2565);
			attr_dev(h11, "class", "svelte-1y6sxs9");
			add_location(h11, file, 109, 4, 3077);
			attr_dev(div3, "class", "projectTitle svelte-1y6sxs9");
			add_location(div3, file, 108, 3, 3046);
			attr_dev(p2, "class", "svelte-1y6sxs9");
			add_location(p2, file, 112, 4, 3136);
			attr_dev(p3, "class", "svelte-1y6sxs9");
			add_location(p3, file, 115, 4, 3181);
			attr_dev(p4, "class", "svelte-1y6sxs9");
			add_location(p4, file, 119, 4, 3319);
			attr_dev(div4, "class", "projectBody svelte-1y6sxs9");
			add_location(div4, file, 111, 3, 3106);
			attr_dev(div5, "class", "projectTile svelte-1y6sxs9");
			add_location(div5, file, 107, 2, 3017);
			attr_dev(a1, "href", "https://coopscodes.github.io/resume/");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-1y6sxs9");
			add_location(a1, file, 106, 1, 2951);
			attr_dev(h12, "class", "svelte-1y6sxs9");
			add_location(h12, file, 129, 4, 3515);
			attr_dev(div6, "class", "projectTitle svelte-1y6sxs9");
			add_location(div6, file, 128, 3, 3484);
			attr_dev(p5, "class", "svelte-1y6sxs9");
			add_location(p5, file, 132, 4, 3594);
			attr_dev(p6, "class", "svelte-1y6sxs9");
			add_location(p6, file, 139, 4, 3808);
			attr_dev(div7, "class", "projectBody svelte-1y6sxs9");
			add_location(div7, file, 131, 3, 3564);
			attr_dev(div8, "class", "projectTile svelte-1y6sxs9");
			add_location(div8, file, 127, 2, 3455);
			attr_dev(a2, "href", "https://github.com/CoopsCodes/CSharpRobot");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-1y6sxs9");
			add_location(a2, file, 126, 1, 3384);
			attr_dev(h13, "class", "svelte-1y6sxs9");
			add_location(h13, file, 149, 4, 4001);
			attr_dev(div9, "class", "projectTitle svelte-1y6sxs9");
			add_location(div9, file, 148, 3, 3970);
			attr_dev(p7, "class", "svelte-1y6sxs9");
			add_location(p7, file, 152, 4, 4066);
			attr_dev(p8, "class", "svelte-1y6sxs9");
			add_location(p8, file, 155, 4, 4141);
			attr_dev(p9, "class", "svelte-1y6sxs9");
			add_location(p9, file, 158, 4, 4208);
			attr_dev(div10, "class", "projectBody svelte-1y6sxs9");
			add_location(div10, file, 151, 3, 4036);
			attr_dev(div11, "class", "projectTile svelte-1y6sxs9");
			add_location(div11, file, 147, 2, 3941);
			attr_dev(a3, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-1y6sxs9");
			add_location(a3, file, 146, 1, 3868);
			attr_dev(h14, "class", "svelte-1y6sxs9");
			add_location(h14, file, 168, 4, 4394);
			attr_dev(div12, "class", "projectTitle svelte-1y6sxs9");
			add_location(div12, file, 167, 3, 4363);
			attr_dev(p10, "class", "svelte-1y6sxs9");
			add_location(p10, file, 171, 4, 4453);
			attr_dev(p11, "class", "svelte-1y6sxs9");
			add_location(p11, file, 175, 4, 4583);
			attr_dev(div13, "class", "projectBody svelte-1y6sxs9");
			add_location(div13, file, 170, 3, 4423);
			attr_dev(div14, "class", "projectTile svelte-1y6sxs9");
			add_location(div14, file, 166, 2, 4334);
			attr_dev(a4, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-1y6sxs9");
			add_location(a4, file, 165, 1, 4268);
			attr_dev(h15, "class", "svelte-1y6sxs9");
			add_location(h15, file, 188, 4, 4800);
			attr_dev(div15, "class", "projectTitle svelte-1y6sxs9");
			add_location(div15, file, 187, 3, 4769);
			attr_dev(p12, "class", "svelte-1y6sxs9");
			add_location(p12, file, 191, 4, 4884);
			attr_dev(p13, "class", "svelte-1y6sxs9");
			add_location(p13, file, 195, 4, 4990);
			attr_dev(div16, "class", "projectBody svelte-1y6sxs9");
			add_location(div16, file, 190, 3, 4854);
			attr_dev(div17, "class", "projectTile svelte-1y6sxs9");
			add_location(div17, file, 186, 2, 4740);
			attr_dev(a5, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a5, "target", "_blank");
			attr_dev(a5, "class", "svelte-1y6sxs9");
			add_location(a5, file, 182, 1, 4643);
			attr_dev(body, "class", "projectsContainer svelte-1y6sxs9");
			add_location(body, file, 67, 0, 2042);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
