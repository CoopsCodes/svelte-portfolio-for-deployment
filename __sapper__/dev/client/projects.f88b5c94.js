...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-7808ly");
			add_location(h10, file, 93, 4, 2742);
			attr_dev(div0, "class", "projectTitle svelte-7808ly");
			add_location(div0, file, 92, 3, 2711);
			attr_dev(p0, "class", "svelte-7808ly");
			add_location(p0, file, 96, 4, 2809);
			attr_dev(p1, "class", "svelte-7808ly");
			add_location(p1, file, 99, 4, 2885);
			attr_dev(div1, "class", "projectBody svelte-7808ly");
			add_location(div1, file, 95, 3, 2779);
			attr_dev(div2, "class", "projectTile svelte-7808ly");
			add_location(div2, file, 91, 2, 2682);
			attr_dev(a0, "href", "This Website");
			attr_dev(a0, "onclick", "return false");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-7808ly");
			add_location(a0, file, 90, 1, 2617);
			attr_dev(h11, "class", "svelte-7808ly");
			add_location(h11, file, 110, 4, 3125);
			attr_dev(div3, "class", "projectTitle svelte-7808ly");
			add_location(div3, file, 109, 3, 3094);
			attr_dev(p2, "class", "svelte-7808ly");
			add_location(p2, file, 113, 4, 3184);
			attr_dev(p3, "class", "svelte-7808ly");
			add_location(p3, file, 116, 4, 3229);
			attr_dev(p4, "class", "svelte-7808ly");
			add_location(p4, file, 120, 4, 3367);
			attr_dev(div4, "class", "projectBody svelte-7808ly");
			add_location(div4, file, 112, 3, 3154);
			attr_dev(div5, "class", "projectTile svelte-7808ly");
			add_location(div5, file, 108, 2, 3065);
			attr_dev(a1, "href", "https://coopscodes.github.io/resume/");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-7808ly");
			add_location(a1, file, 107, 1, 2999);
			attr_dev(h12, "class", "svelte-7808ly");
			add_location(h12, file, 130, 4, 3563);
			attr_dev(div6, "class", "projectTitle svelte-7808ly");
			add_location(div6, file, 129, 3, 3532);
			attr_dev(p5, "class", "svelte-7808ly");
			add_location(p5, file, 133, 4, 3642);
			attr_dev(p6, "class", "svelte-7808ly");
			add_location(p6, file, 140, 4, 3856);
			attr_dev(div7, "class", "projectBody svelte-7808ly");
			add_location(div7, file, 132, 3, 3612);
			attr_dev(div8, "class", "projectTile svelte-7808ly");
			add_location(div8, file, 128, 2, 3503);
			attr_dev(a2, "href", "https://github.com/CoopsCodes/CSharpRobot");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-7808ly");
			add_location(a2, file, 127, 1, 3432);
			attr_dev(h13, "class", "svelte-7808ly");
			add_location(h13, file, 150, 4, 4049);
			attr_dev(div9, "class", "projectTitle svelte-7808ly");
			add_location(div9, file, 149, 3, 4018);
			attr_dev(p7, "class", "svelte-7808ly");
			add_location(p7, file, 153, 4, 4114);
			attr_dev(p8, "class", "svelte-7808ly");
			add_location(p8, file, 156, 4, 4189);
			attr_dev(p9, "class", "svelte-7808ly");
			add_location(p9, file, 159, 4, 4256);
			attr_dev(div10, "class", "projectBody svelte-7808ly");
			add_location(div10, file, 152, 3, 4084);
			attr_dev(div11, "class", "projectTile svelte-7808ly");
			add_location(div11, file, 148, 2, 3989);
			attr_dev(a3, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-7808ly");
			add_location(a3, file, 147, 1, 3916);
			attr_dev(h14, "class", "svelte-7808ly");
			add_location(h14, file, 169, 4, 4442);
			attr_dev(div12, "class", "projectTitle svelte-7808ly");
			add_location(div12, file, 168, 3, 4411);
			attr_dev(p10, "class", "svelte-7808ly");
			add_location(p10, file, 172, 4, 4501);
			attr_dev(p11, "class", "svelte-7808ly");
			add_location(p11, file, 176, 4, 4631);
			attr_dev(div13, "class", "projectBody svelte-7808ly");
			add_location(div13, file, 171, 3, 4471);
			attr_dev(div14, "class", "projectTile svelte-7808ly");
			add_location(div14, file, 167, 2, 4382);
			attr_dev(a4, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-7808ly");
			add_location(a4, file, 166, 1, 4316);
			attr_dev(h15, "class", "svelte-7808ly");
			add_location(h15, file, 189, 4, 4848);
			attr_dev(div15, "class", "projectTitle svelte-7808ly");
			add_location(div15, file, 188, 3, 4817);
			attr_dev(p12, "class", "svelte-7808ly");
			add_location(p12, file, 192, 4, 4932);
			attr_dev(p13, "class", "svelte-7808ly");
			add_location(p13, file, 196, 4, 5038);
			attr_dev(div16, "class", "projectBody svelte-7808ly");
			add_location(div16, file, 191, 3, 4902);
			attr_dev(div17, "class", "projectTile svelte-7808ly");
			add_location(div17, file, 187, 2, 4788);
			attr_dev(a5, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a5, "target", "_blank");
			attr_dev(a5, "class", "svelte-7808ly");
			add_location(a5, file, 183, 1, 4691);
			attr_dev(body, "class", "projectsContainer svelte-7808ly");
			add_location(body, file, 68, 0, 2094);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
