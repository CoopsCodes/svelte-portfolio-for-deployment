...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-tnd0e4");
			add_location(h10, file, 71, 4, 2046);
			attr_dev(div0, "class", "projectTitle svelte-tnd0e4");
			add_location(div0, file, 70, 3, 2015);
			attr_dev(p0, "class", "svelte-tnd0e4");
			add_location(p0, file, 74, 4, 2111);
			attr_dev(p1, "class", "svelte-tnd0e4");
			add_location(p1, file, 77, 4, 2193);
			attr_dev(div1, "class", "projectBody svelte-tnd0e4");
			add_location(div1, file, 73, 3, 2081);
			attr_dev(div2, "class", "projectTile svelte-tnd0e4");
			add_location(div2, file, 69, 2, 1986);
			attr_dev(a0, "href", "This Website");
			attr_dev(a0, "onclick", "return false");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-tnd0e4");
			add_location(a0, file, 68, 1, 1921);
			attr_dev(h11, "class", "svelte-tnd0e4");
			add_location(h11, file, 88, 4, 2433);
			attr_dev(div3, "class", "projectTitle svelte-tnd0e4");
			add_location(div3, file, 87, 3, 2402);
			attr_dev(p2, "class", "svelte-tnd0e4");
			add_location(p2, file, 91, 4, 2492);
			attr_dev(p3, "class", "svelte-tnd0e4");
			add_location(p3, file, 94, 4, 2537);
			attr_dev(p4, "class", "svelte-tnd0e4");
			add_location(p4, file, 98, 4, 2675);
			attr_dev(div4, "class", "projectBody svelte-tnd0e4");
			add_location(div4, file, 90, 3, 2462);
			attr_dev(div5, "class", "projectTile svelte-tnd0e4");
			add_location(div5, file, 86, 2, 2373);
			attr_dev(a1, "href", "https://coopscodes.github.io/resume/");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-tnd0e4");
			add_location(a1, file, 85, 1, 2307);
			attr_dev(h12, "class", "svelte-tnd0e4");
			add_location(h12, file, 108, 4, 2871);
			attr_dev(div6, "class", "projectTitle svelte-tnd0e4");
			add_location(div6, file, 107, 3, 2840);
			attr_dev(p5, "class", "svelte-tnd0e4");
			add_location(p5, file, 111, 4, 2950);
			attr_dev(p6, "class", "svelte-tnd0e4");
			add_location(p6, file, 118, 4, 3164);
			attr_dev(div7, "class", "projectBody svelte-tnd0e4");
			add_location(div7, file, 110, 3, 2920);
			attr_dev(div8, "class", "projectTile svelte-tnd0e4");
			add_location(div8, file, 106, 2, 2811);
			attr_dev(a2, "href", "https://github.com/CoopsCodes/CSharpRobot");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-tnd0e4");
			add_location(a2, file, 105, 1, 2740);
			attr_dev(h13, "class", "svelte-tnd0e4");
			add_location(h13, file, 128, 4, 3357);
			attr_dev(div9, "class", "projectTitle svelte-tnd0e4");
			add_location(div9, file, 127, 3, 3326);
			attr_dev(p7, "class", "svelte-tnd0e4");
			add_location(p7, file, 131, 4, 3422);
			attr_dev(p8, "class", "svelte-tnd0e4");
			add_location(p8, file, 134, 4, 3497);
			attr_dev(p9, "class", "svelte-tnd0e4");
			add_location(p9, file, 137, 4, 3564);
			attr_dev(div10, "class", "projectBody svelte-tnd0e4");
			add_location(div10, file, 130, 3, 3392);
			attr_dev(div11, "class", "projectTile svelte-tnd0e4");
			add_location(div11, file, 126, 2, 3297);
			attr_dev(a3, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-tnd0e4");
			add_location(a3, file, 125, 1, 3224);
			attr_dev(h14, "class", "svelte-tnd0e4");
			add_location(h14, file, 147, 4, 3750);
			attr_dev(div12, "class", "projectTitle svelte-tnd0e4");
			add_location(div12, file, 146, 3, 3719);
			attr_dev(p10, "class", "svelte-tnd0e4");
			add_location(p10, file, 150, 4, 3809);
			attr_dev(p11, "class", "svelte-tnd0e4");
			add_location(p11, file, 154, 4, 3939);
			attr_dev(div13, "class", "projectBody svelte-tnd0e4");
			add_location(div13, file, 149, 3, 3779);
			attr_dev(div14, "class", "projectTile svelte-tnd0e4");
			add_location(div14, file, 145, 2, 3690);
			attr_dev(a4, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-tnd0e4");
			add_location(a4, file, 144, 1, 3624);
			attr_dev(h15, "class", "svelte-tnd0e4");
			add_location(h15, file, 167, 4, 4156);
			attr_dev(div15, "class", "projectTitle svelte-tnd0e4");
			add_location(div15, file, 166, 3, 4125);
			attr_dev(p12, "class", "svelte-tnd0e4");
			add_location(p12, file, 170, 4, 4240);
			attr_dev(p13, "class", "svelte-tnd0e4");
			add_location(p13, file, 174, 4, 4346);
			attr_dev(div16, "class", "projectBody svelte-tnd0e4");
			add_location(div16, file, 169, 3, 4210);
			attr_dev(div17, "class", "projectTile svelte-tnd0e4");
			add_location(div17, file, 165, 2, 4096);
			attr_dev(a5, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a5, "target", "_blank");
			attr_dev(a5, "class", "svelte-tnd0e4");
			add_location(a5, file, 161, 1, 3999);
			attr_dev(body, "class", "projectsContainer svelte-tnd0e4");
			add_location(body, file, 46, 0, 1398);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
