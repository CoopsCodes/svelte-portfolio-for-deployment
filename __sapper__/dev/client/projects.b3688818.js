...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-a21ljg");
			add_location(h10, file, 88, 4, 2526);
			attr_dev(div0, "class", "projectTitle svelte-a21ljg");
			add_location(div0, file, 87, 3, 2495);
			attr_dev(p0, "class", "svelte-a21ljg");
			add_location(p0, file, 91, 4, 2591);
			attr_dev(p1, "class", "svelte-a21ljg");
			add_location(p1, file, 94, 4, 2673);
			attr_dev(div1, "class", "projectBody svelte-a21ljg");
			add_location(div1, file, 90, 3, 2561);
			attr_dev(div2, "class", "projectTile svelte-a21ljg");
			add_location(div2, file, 86, 2, 2466);
			attr_dev(a0, "href", "This Website");
			attr_dev(a0, "onclick", "return false");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-a21ljg");
			add_location(a0, file, 85, 1, 2401);
			attr_dev(h11, "class", "svelte-a21ljg");
			add_location(h11, file, 105, 4, 2913);
			attr_dev(div3, "class", "projectTitle svelte-a21ljg");
			add_location(div3, file, 104, 3, 2882);
			attr_dev(p2, "class", "svelte-a21ljg");
			add_location(p2, file, 108, 4, 2972);
			attr_dev(p3, "class", "svelte-a21ljg");
			add_location(p3, file, 111, 4, 3017);
			attr_dev(p4, "class", "svelte-a21ljg");
			add_location(p4, file, 115, 4, 3155);
			attr_dev(div4, "class", "projectBody svelte-a21ljg");
			add_location(div4, file, 107, 3, 2942);
			attr_dev(div5, "class", "projectTile svelte-a21ljg");
			add_location(div5, file, 103, 2, 2853);
			attr_dev(a1, "href", "https://coopscodes.github.io/resume/");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-a21ljg");
			add_location(a1, file, 102, 1, 2787);
			attr_dev(h12, "class", "svelte-a21ljg");
			add_location(h12, file, 125, 4, 3351);
			attr_dev(div6, "class", "projectTitle svelte-a21ljg");
			add_location(div6, file, 124, 3, 3320);
			attr_dev(p5, "class", "svelte-a21ljg");
			add_location(p5, file, 128, 4, 3430);
			attr_dev(p6, "class", "svelte-a21ljg");
			add_location(p6, file, 135, 4, 3644);
			attr_dev(div7, "class", "projectBody svelte-a21ljg");
			add_location(div7, file, 127, 3, 3400);
			attr_dev(div8, "class", "projectTile svelte-a21ljg");
			add_location(div8, file, 123, 2, 3291);
			attr_dev(a2, "href", "https://github.com/CoopsCodes/CSharpRobot");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-a21ljg");
			add_location(a2, file, 122, 1, 3220);
			attr_dev(h13, "class", "svelte-a21ljg");
			add_location(h13, file, 145, 4, 3837);
			attr_dev(div9, "class", "projectTitle svelte-a21ljg");
			add_location(div9, file, 144, 3, 3806);
			attr_dev(p7, "class", "svelte-a21ljg");
			add_location(p7, file, 148, 4, 3902);
			attr_dev(p8, "class", "svelte-a21ljg");
			add_location(p8, file, 151, 4, 3977);
			attr_dev(p9, "class", "svelte-a21ljg");
			add_location(p9, file, 154, 4, 4044);
			attr_dev(div10, "class", "projectBody svelte-a21ljg");
			add_location(div10, file, 147, 3, 3872);
			attr_dev(div11, "class", "projectTile svelte-a21ljg");
			add_location(div11, file, 143, 2, 3777);
			attr_dev(a3, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-a21ljg");
			add_location(a3, file, 142, 1, 3704);
			attr_dev(h14, "class", "svelte-a21ljg");
			add_location(h14, file, 164, 4, 4230);
			attr_dev(div12, "class", "projectTitle svelte-a21ljg");
			add_location(div12, file, 163, 3, 4199);
			attr_dev(p10, "class", "svelte-a21ljg");
			add_location(p10, file, 167, 4, 4289);
			attr_dev(p11, "class", "svelte-a21ljg");
			add_location(p11, file, 171, 4, 4419);
			attr_dev(div13, "class", "projectBody svelte-a21ljg");
			add_location(div13, file, 166, 3, 4259);
			attr_dev(div14, "class", "projectTile svelte-a21ljg");
			add_location(div14, file, 162, 2, 4170);
			attr_dev(a4, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-a21ljg");
			add_location(a4, file, 161, 1, 4104);
			attr_dev(h15, "class", "svelte-a21ljg");
			add_location(h15, file, 184, 4, 4636);
			attr_dev(div15, "class", "projectTitle svelte-a21ljg");
			add_location(div15, file, 183, 3, 4605);
			attr_dev(p12, "class", "svelte-a21ljg");
			add_location(p12, file, 187, 4, 4720);
			attr_dev(p13, "class", "svelte-a21ljg");
			add_location(p13, file, 191, 4, 4826);
			attr_dev(div16, "class", "projectBody svelte-a21ljg");
			add_location(div16, file, 186, 3, 4690);
			attr_dev(div17, "class", "projectTile svelte-a21ljg");
			add_location(div17, file, 182, 2, 4576);
			attr_dev(a5, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a5, "target", "_blank");
			attr_dev(a5, "class", "svelte-a21ljg");
			add_location(a5, file, 178, 1, 4479);
			attr_dev(body, "class", "projectsContainer svelte-a21ljg");
			add_location(body, file, 63, 0, 1878);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
