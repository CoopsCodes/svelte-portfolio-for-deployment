...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-1nix5ip");
			add_location(h10, file, 84, 4, 2468);
			attr_dev(div0, "class", "projectTitle svelte-1nix5ip");
			add_location(div0, file, 83, 3, 2437);
			attr_dev(p0, "class", "svelte-1nix5ip");
			add_location(p0, file, 87, 4, 2533);
			attr_dev(p1, "class", "svelte-1nix5ip");
			add_location(p1, file, 90, 4, 2615);
			attr_dev(div1, "class", "projectBody svelte-1nix5ip");
			add_location(div1, file, 86, 3, 2503);
			attr_dev(div2, "class", "projectTile svelte-1nix5ip");
			add_location(div2, file, 82, 2, 2408);
			attr_dev(a0, "href", "This Website");
			attr_dev(a0, "onclick", "return false");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-1nix5ip");
			add_location(a0, file, 81, 1, 2343);
			attr_dev(h11, "class", "svelte-1nix5ip");
			add_location(h11, file, 101, 4, 2855);
			attr_dev(div3, "class", "projectTitle svelte-1nix5ip");
			add_location(div3, file, 100, 3, 2824);
			attr_dev(p2, "class", "svelte-1nix5ip");
			add_location(p2, file, 104, 4, 2914);
			attr_dev(p3, "class", "svelte-1nix5ip");
			add_location(p3, file, 107, 4, 2959);
			attr_dev(p4, "class", "svelte-1nix5ip");
			add_location(p4, file, 111, 4, 3097);
			attr_dev(div4, "class", "projectBody svelte-1nix5ip");
			add_location(div4, file, 103, 3, 2884);
			attr_dev(div5, "class", "projectTile svelte-1nix5ip");
			add_location(div5, file, 99, 2, 2795);
			attr_dev(a1, "href", "https://coopscodes.github.io/resume/");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-1nix5ip");
			add_location(a1, file, 98, 1, 2729);
			attr_dev(h12, "class", "svelte-1nix5ip");
			add_location(h12, file, 121, 4, 3293);
			attr_dev(div6, "class", "projectTitle svelte-1nix5ip");
			add_location(div6, file, 120, 3, 3262);
			attr_dev(p5, "class", "svelte-1nix5ip");
			add_location(p5, file, 124, 4, 3372);
			attr_dev(p6, "class", "svelte-1nix5ip");
			add_location(p6, file, 131, 4, 3586);
			attr_dev(div7, "class", "projectBody svelte-1nix5ip");
			add_location(div7, file, 123, 3, 3342);
			attr_dev(div8, "class", "projectTile svelte-1nix5ip");
			add_location(div8, file, 119, 2, 3233);
			attr_dev(a2, "href", "https://github.com/CoopsCodes/CSharpRobot");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-1nix5ip");
			add_location(a2, file, 118, 1, 3162);
			attr_dev(h13, "class", "svelte-1nix5ip");
			add_location(h13, file, 141, 4, 3779);
			attr_dev(div9, "class", "projectTitle svelte-1nix5ip");
			add_location(div9, file, 140, 3, 3748);
			attr_dev(p7, "class", "svelte-1nix5ip");
			add_location(p7, file, 144, 4, 3844);
			attr_dev(p8, "class", "svelte-1nix5ip");
			add_location(p8, file, 147, 4, 3919);
			attr_dev(p9, "class", "svelte-1nix5ip");
			add_location(p9, file, 150, 4, 3986);
			attr_dev(div10, "class", "projectBody svelte-1nix5ip");
			add_location(div10, file, 143, 3, 3814);
			attr_dev(div11, "class", "projectTile svelte-1nix5ip");
			add_location(div11, file, 139, 2, 3719);
			attr_dev(a3, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-1nix5ip");
			add_location(a3, file, 138, 1, 3646);
			attr_dev(h14, "class", "svelte-1nix5ip");
			add_location(h14, file, 160, 4, 4172);
			attr_dev(div12, "class", "projectTitle svelte-1nix5ip");
			add_location(div12, file, 159, 3, 4141);
			attr_dev(p10, "class", "svelte-1nix5ip");
			add_location(p10, file, 163, 4, 4231);
			attr_dev(p11, "class", "svelte-1nix5ip");
			add_location(p11, file, 167, 4, 4361);
			attr_dev(div13, "class", "projectBody svelte-1nix5ip");
			add_location(div13, file, 162, 3, 4201);
			attr_dev(div14, "class", "projectTile svelte-1nix5ip");
			add_location(div14, file, 158, 2, 4112);
			attr_dev(a4, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-1nix5ip");
			add_location(a4, file, 157, 1, 4046);
			attr_dev(h15, "class", "svelte-1nix5ip");
			add_location(h15, file, 180, 4, 4578);
			attr_dev(div15, "class", "projectTitle svelte-1nix5ip");
			add_location(div15, file, 179, 3, 4547);
			attr_dev(p12, "class", "svelte-1nix5ip");
			add_location(p12, file, 183, 4, 4662);
			attr_dev(p13, "class", "svelte-1nix5ip");
			add_location(p13, file, 187, 4, 4768);
			attr_dev(div16, "class", "projectBody svelte-1nix5ip");
			add_location(div16, file, 182, 3, 4632);
			attr_dev(div17, "class", "projectTile svelte-1nix5ip");
			add_location(div17, file, 178, 2, 4518);
			attr_dev(a5, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a5, "target", "_blank");
			attr_dev(a5, "class", "svelte-1nix5ip");
			add_location(a5, file, 174, 1, 4421);
			attr_dev(body, "class", "projectsContainer svelte-1nix5ip");
			add_location(body, file, 59, 0, 1820);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
