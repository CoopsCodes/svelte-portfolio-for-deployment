import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, o as onMount, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, p as binding_callbacks, r as globals } from './client.45684729.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(canvas_1, "class", "svelte-ncnpo3");
			add_location(canvas_1, file, 213, 1, 4543);
			attr_dev(div0, "class", "background svelte-ncnpo3");
			add_location(div0, file, 214, 1, 4595);
			attr_dev(p0, "class", "svelte-ncnpo3");
			add_location(p0, file, 216, 2, 4648);
			attr_dev(p1, "class", "svelte-ncnpo3");
			add_location(p1, file, 217, 2, 4670);
			attr_dev(p2, "class", "svelte-ncnpo3");
			add_location(p2, file, 221, 2, 4769);
			attr_dev(p3, "class", "svelte-ncnpo3");
			add_location(p3, file, 226, 2, 4977);
			attr_dev(p4, "class", "svelte-ncnpo3");
			add_location(p4, file, 231, 2, 5156);
			attr_dev(p5, "class", "svelte-ncnpo3");
			add_location(p5, file, 237, 2, 5446);
			attr_dev(p6, "class", "svelte-ncnpo3");
			add_location(p6, file, 242, 2, 5639);
			attr_dev(div1, "class", "main svelte-ncnpo3");
			add_location(div1, file, 215, 1, 4627);
			attr_dev(body, "class", "svelte-ncnpo3");
			add_location(body, file, 212, 0, 4535);
		},
