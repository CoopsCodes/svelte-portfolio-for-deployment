...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-117o455");
			add_location(h10, file, 70, 8, 2108);
			attr_dev(div0, "class", "projectTitle svelte-117o455");
			add_location(div0, file, 69, 6, 2073);
			attr_dev(p0, "class", "svelte-117o455");
			add_location(p0, file, 73, 8, 2187);
			attr_dev(p1, "class", "svelte-117o455");
			add_location(p1, file, 76, 8, 2240);
			attr_dev(p2, "class", "svelte-117o455");
			add_location(p2, file, 79, 8, 2328);
			attr_dev(div1, "class", "projectBody svelte-117o455");
			add_location(div1, file, 72, 6, 2153);
			attr_dev(div2, "class", "projectTile svelte-117o455");
			add_location(div2, file, 68, 4, 2041);
			attr_dev(a0, "href", "https://cooper-codes.dev/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-117o455");
			add_location(a0, file, 67, 2, 1984);
			attr_dev(h11, "class", "svelte-117o455");
			add_location(h11, file, 89, 8, 2543);
			attr_dev(div3, "class", "projectTitle svelte-117o455");
			add_location(div3, file, 88, 6, 2508);
			attr_dev(p3, "class", "svelte-117o455");
			add_location(p3, file, 92, 8, 2618);
			attr_dev(div4, "class", "projectBody svelte-117o455");
			add_location(div4, file, 91, 6, 2584);
			attr_dev(div5, "class", "projectTile svelte-117o455");
			add_location(div5, file, 87, 4, 2476);
			attr_dev(a1, "href", "This Website");
			attr_dev(a1, "onclick", "return false");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-117o455");
			add_location(a1, file, 86, 2, 2409);
			attr_dev(h12, "class", "svelte-117o455");
			add_location(h12, file, 102, 8, 2892);
			attr_dev(div6, "class", "projectTitle svelte-117o455");
			add_location(div6, file, 101, 6, 2857);
			attr_dev(p4, "class", "svelte-117o455");
			add_location(p4, file, 105, 8, 2967);
			attr_dev(p5, "class", "svelte-117o455");
			add_location(p5, file, 108, 8, 3055);
			attr_dev(p6, "class", "svelte-117o455");
			add_location(p6, file, 111, 8, 3135);
			attr_dev(div7, "class", "projectBody svelte-117o455");
			add_location(div7, file, 104, 6, 2933);
			attr_dev(div8, "class", "projectTile svelte-117o455");
			add_location(div8, file, 100, 4, 2825);
			attr_dev(a2, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-117o455");
			add_location(a2, file, 99, 2, 2750);
			attr_dev(h13, "class", "svelte-117o455");
			add_location(h13, file, 121, 8, 3351);
			attr_dev(div9, "class", "projectTitle svelte-117o455");
			add_location(div9, file, 120, 6, 3316);
			attr_dev(p7, "class", "svelte-117o455");
			add_location(p7, file, 124, 8, 3420);
			attr_dev(p8, "class", "svelte-117o455");
			add_location(p8, file, 128, 8, 3568);
			attr_dev(div10, "class", "projectBody svelte-117o455");
			add_location(div10, file, 123, 6, 3386);
			attr_dev(div11, "class", "projectTile svelte-117o455");
			add_location(div11, file, 119, 4, 3284);
			attr_dev(a3, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-117o455");
			add_location(a3, file, 118, 2, 3216);
			attr_dev(h14, "class", "svelte-117o455");
			add_location(h14, file, 141, 8, 3820);
			attr_dev(div12, "class", "projectTitle svelte-117o455");
			add_location(div12, file, 140, 6, 3785);
			attr_dev(p9, "class", "svelte-117o455");
			add_location(p9, file, 144, 8, 3914);
			attr_dev(p10, "class", "svelte-117o455");
			add_location(p10, file, 148, 8, 4038);
			attr_dev(div13, "class", "projectBody svelte-117o455");
			add_location(div13, file, 143, 6, 3880);
			attr_dev(div14, "class", "projectTile svelte-117o455");
			add_location(div14, file, 139, 4, 3753);
			attr_dev(a4, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-117o455");
			add_location(a4, file, 135, 2, 3649);
			attr_dev(body, "class", "projectsContainer svelte-117o455");
			add_location(body, file, 66, 0, 1949);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
