import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, o as onMount, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, p as binding_callbacks, r as globals } from './client.48ca8be0.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(canvas_1, "class", "svelte-1qea4iv");
			add_location(canvas_1, file, 219, 1, 4558);
			attr_dev(p0, "class", "svelte-1qea4iv");
			add_location(p0, file, 222, 3, 4663);
			attr_dev(p1, "class", "svelte-1qea4iv");
			add_location(p1, file, 223, 3, 4686);
			attr_dev(p2, "class", "svelte-1qea4iv");
			add_location(p2, file, 228, 3, 4894);
			attr_dev(p3, "class", "svelte-1qea4iv");
			add_location(p3, file, 233, 3, 5067);
			attr_dev(p4, "class", "svelte-1qea4iv");
			add_location(p4, file, 239, 3, 5292);
			attr_dev(p5, "class", "svelte-1qea4iv");
			add_location(p5, file, 244, 3, 5490);
			attr_dev(div0, "class", "main svelte-1qea4iv");
			add_location(div0, file, 221, 2, 4641);
			attr_dev(div1, "class", "socials svelte-1qea4iv");
			add_location(div1, file, 252, 2, 5822);
			attr_dev(div2, "class", "grid-container svelte-1qea4iv");
			add_location(div2, file, 220, 1, 4610);
			attr_dev(body, "class", "svelte-1qea4iv");
			add_location(body, file, 218, 0, 4550);
		},
