...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-pr3rwk");
			add_location(h10, file, 94, 4, 2765);
			attr_dev(div0, "class", "projectTitle svelte-pr3rwk");
			add_location(div0, file, 93, 3, 2734);
			attr_dev(p0, "class", "svelte-pr3rwk");
			add_location(p0, file, 97, 4, 2832);
			attr_dev(p1, "class", "svelte-pr3rwk");
			add_location(p1, file, 100, 4, 2908);
			attr_dev(div1, "class", "projectBody svelte-pr3rwk");
			add_location(div1, file, 96, 3, 2802);
			attr_dev(div2, "class", "projectTile svelte-pr3rwk");
			add_location(div2, file, 92, 2, 2705);
			attr_dev(a0, "href", "This Website");
			attr_dev(a0, "onclick", "return false");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-pr3rwk");
			add_location(a0, file, 91, 1, 2640);
			attr_dev(h11, "class", "svelte-pr3rwk");
			add_location(h11, file, 111, 4, 3148);
			attr_dev(div3, "class", "projectTitle svelte-pr3rwk");
			add_location(div3, file, 110, 3, 3117);
			attr_dev(p2, "class", "svelte-pr3rwk");
			add_location(p2, file, 114, 4, 3207);
			attr_dev(p3, "class", "svelte-pr3rwk");
			add_location(p3, file, 117, 4, 3252);
			attr_dev(p4, "class", "svelte-pr3rwk");
			add_location(p4, file, 121, 4, 3390);
			attr_dev(div4, "class", "projectBody svelte-pr3rwk");
			add_location(div4, file, 113, 3, 3177);
			attr_dev(div5, "class", "projectTile svelte-pr3rwk");
			add_location(div5, file, 109, 2, 3088);
			attr_dev(a1, "href", "https://coopscodes.github.io/resume/");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-pr3rwk");
			add_location(a1, file, 108, 1, 3022);
			attr_dev(h12, "class", "svelte-pr3rwk");
			add_location(h12, file, 131, 4, 3586);
			attr_dev(div6, "class", "projectTitle svelte-pr3rwk");
			add_location(div6, file, 130, 3, 3555);
			attr_dev(p5, "class", "svelte-pr3rwk");
			add_location(p5, file, 134, 4, 3665);
			attr_dev(p6, "class", "svelte-pr3rwk");
			add_location(p6, file, 141, 4, 3879);
			attr_dev(div7, "class", "projectBody svelte-pr3rwk");
			add_location(div7, file, 133, 3, 3635);
			attr_dev(div8, "class", "projectTile svelte-pr3rwk");
			add_location(div8, file, 129, 2, 3526);
			attr_dev(a2, "href", "https://github.com/CoopsCodes/CSharpRobot");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-pr3rwk");
			add_location(a2, file, 128, 1, 3455);
			attr_dev(h13, "class", "svelte-pr3rwk");
			add_location(h13, file, 151, 4, 4072);
			attr_dev(div9, "class", "projectTitle svelte-pr3rwk");
			add_location(div9, file, 150, 3, 4041);
			attr_dev(p7, "class", "svelte-pr3rwk");
			add_location(p7, file, 154, 4, 4137);
			attr_dev(p8, "class", "svelte-pr3rwk");
			add_location(p8, file, 157, 4, 4212);
			attr_dev(p9, "class", "svelte-pr3rwk");
			add_location(p9, file, 160, 4, 4279);
			attr_dev(div10, "class", "projectBody svelte-pr3rwk");
			add_location(div10, file, 153, 3, 4107);
			attr_dev(div11, "class", "projectTile svelte-pr3rwk");
			add_location(div11, file, 149, 2, 4012);
			attr_dev(a3, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-pr3rwk");
			add_location(a3, file, 148, 1, 3939);
			attr_dev(h14, "class", "svelte-pr3rwk");
			add_location(h14, file, 170, 4, 4465);
			attr_dev(div12, "class", "projectTitle svelte-pr3rwk");
			add_location(div12, file, 169, 3, 4434);
			attr_dev(p10, "class", "svelte-pr3rwk");
			add_location(p10, file, 173, 4, 4524);
			attr_dev(p11, "class", "svelte-pr3rwk");
			add_location(p11, file, 177, 4, 4654);
			attr_dev(div13, "class", "projectBody svelte-pr3rwk");
			add_location(div13, file, 172, 3, 4494);
			attr_dev(div14, "class", "projectTile svelte-pr3rwk");
			add_location(div14, file, 168, 2, 4405);
			attr_dev(a4, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-pr3rwk");
			add_location(a4, file, 167, 1, 4339);
			attr_dev(h15, "class", "svelte-pr3rwk");
			add_location(h15, file, 190, 4, 4871);
			attr_dev(div15, "class", "projectTitle svelte-pr3rwk");
			add_location(div15, file, 189, 3, 4840);
			attr_dev(p12, "class", "svelte-pr3rwk");
			add_location(p12, file, 193, 4, 4955);
			attr_dev(p13, "class", "svelte-pr3rwk");
			add_location(p13, file, 197, 4, 5061);
			attr_dev(div16, "class", "projectBody svelte-pr3rwk");
			add_location(div16, file, 192, 3, 4925);
			attr_dev(div17, "class", "projectTile svelte-pr3rwk");
			add_location(div17, file, 188, 2, 4811);
			attr_dev(a5, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a5, "target", "_blank");
			attr_dev(a5, "class", "svelte-pr3rwk");
			add_location(a5, file, 184, 1, 4714);
			attr_dev(body, "class", "projectsContainer svelte-pr3rwk");
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
