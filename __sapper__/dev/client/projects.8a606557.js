...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-1uj2jqb");
			add_location(h10, file, 63, 8, 1853);
			attr_dev(div0, "class", "projectTitle svelte-1uj2jqb");
			add_location(div0, file, 62, 6, 1818);
			attr_dev(p0, "class", "svelte-1uj2jqb");
			add_location(p0, file, 66, 8, 1932);
			attr_dev(p1, "class", "svelte-1uj2jqb");
			add_location(p1, file, 69, 8, 1985);
			attr_dev(p2, "class", "svelte-1uj2jqb");
			add_location(p2, file, 72, 8, 2073);
			attr_dev(div1, "class", "projectBody svelte-1uj2jqb");
			add_location(div1, file, 65, 6, 1898);
			attr_dev(div2, "class", "projectTile svelte-1uj2jqb");
			add_location(div2, file, 61, 4, 1786);
			attr_dev(a0, "href", "https://cooper-codes.dev/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-1uj2jqb");
			add_location(a0, file, 60, 2, 1729);
			attr_dev(h11, "class", "svelte-1uj2jqb");
			add_location(h11, file, 82, 8, 2288);
			attr_dev(div3, "class", "projectTitle svelte-1uj2jqb");
			add_location(div3, file, 81, 6, 2253);
			attr_dev(p3, "class", "svelte-1uj2jqb");
			add_location(p3, file, 85, 8, 2363);
			attr_dev(div4, "class", "projectBody svelte-1uj2jqb");
			add_location(div4, file, 84, 6, 2329);
			attr_dev(div5, "class", "projectTile svelte-1uj2jqb");
			add_location(div5, file, 80, 4, 2221);
			attr_dev(a1, "href", "This Website");
			attr_dev(a1, "onclick", "return false");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-1uj2jqb");
			add_location(a1, file, 79, 2, 2154);
			attr_dev(h12, "class", "svelte-1uj2jqb");
			add_location(h12, file, 95, 8, 2637);
			attr_dev(div6, "class", "projectTitle svelte-1uj2jqb");
			add_location(div6, file, 94, 6, 2602);
			attr_dev(p4, "class", "svelte-1uj2jqb");
			add_location(p4, file, 98, 8, 2712);
			attr_dev(p5, "class", "svelte-1uj2jqb");
			add_location(p5, file, 101, 8, 2800);
			attr_dev(p6, "class", "svelte-1uj2jqb");
			add_location(p6, file, 104, 8, 2880);
			attr_dev(div7, "class", "projectBody svelte-1uj2jqb");
			add_location(div7, file, 97, 6, 2678);
			attr_dev(div8, "class", "projectTile svelte-1uj2jqb");
			add_location(div8, file, 93, 4, 2570);
			attr_dev(a2, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-1uj2jqb");
			add_location(a2, file, 92, 2, 2495);
			attr_dev(h13, "class", "svelte-1uj2jqb");
			add_location(h13, file, 114, 8, 3096);
			attr_dev(div9, "class", "projectTitle svelte-1uj2jqb");
			add_location(div9, file, 113, 6, 3061);
			attr_dev(p7, "class", "svelte-1uj2jqb");
			add_location(p7, file, 117, 8, 3165);
			attr_dev(p8, "class", "svelte-1uj2jqb");
			add_location(p8, file, 121, 8, 3313);
			attr_dev(div10, "class", "projectBody svelte-1uj2jqb");
			add_location(div10, file, 116, 6, 3131);
			attr_dev(div11, "class", "projectTile svelte-1uj2jqb");
			add_location(div11, file, 112, 4, 3029);
			attr_dev(a3, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-1uj2jqb");
			add_location(a3, file, 111, 2, 2961);
			attr_dev(h14, "class", "svelte-1uj2jqb");
			add_location(h14, file, 134, 8, 3565);
			attr_dev(div12, "class", "projectTitle svelte-1uj2jqb");
			add_location(div12, file, 133, 6, 3530);
			attr_dev(p9, "class", "svelte-1uj2jqb");
			add_location(p9, file, 137, 8, 3659);
			attr_dev(p10, "class", "svelte-1uj2jqb");
			add_location(p10, file, 141, 8, 3783);
			attr_dev(div13, "class", "projectBody svelte-1uj2jqb");
			add_location(div13, file, 136, 6, 3625);
			attr_dev(div14, "class", "projectTile svelte-1uj2jqb");
			add_location(div14, file, 132, 4, 3498);
			attr_dev(a4, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-1uj2jqb");
			add_location(a4, file, 128, 2, 3394);
			attr_dev(body, "class", "projectsContainer svelte-1uj2jqb");
			add_location(body, file, 59, 0, 1694);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
