import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, o as onMount, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, p as binding_callbacks, r as globals } from './client.9ed47a90.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(canvas_1, "class", "svelte-pbwhcf");
			add_location(canvas_1, file, 220, 1, 4573);
			attr_dev(p0, "class", "svelte-pbwhcf");
			add_location(p0, file, 223, 3, 4678);
			attr_dev(p1, "class", "svelte-pbwhcf");
			add_location(p1, file, 224, 3, 4701);
			attr_dev(p2, "class", "svelte-pbwhcf");
			add_location(p2, file, 229, 3, 4909);
			attr_dev(p3, "class", "svelte-pbwhcf");
			add_location(p3, file, 234, 3, 5082);
			attr_dev(p4, "class", "svelte-pbwhcf");
			add_location(p4, file, 240, 3, 5307);
			attr_dev(p5, "class", "svelte-pbwhcf");
			add_location(p5, file, 245, 3, 5505);
			attr_dev(div0, "class", "main svelte-pbwhcf");
			add_location(div0, file, 222, 2, 4656);
			attr_dev(div1, "class", "socials svelte-pbwhcf");
			add_location(div1, file, 253, 2, 5837);
			attr_dev(div2, "class", "grid-container svelte-pbwhcf");
			add_location(div2, file, 221, 1, 4625);
			attr_dev(body, "class", "svelte-pbwhcf");
			add_location(body, file, 219, 0, 4565);
		},
