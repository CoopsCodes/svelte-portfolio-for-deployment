...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(canvas_1, file, 199, 1, 4258);
			attr_dev(body, "class", "aboutContainer svelte-h7wkot");
			add_location(body, file, 198, 0, 4227);
		},
