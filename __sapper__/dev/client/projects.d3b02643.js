...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-1a75a7r");
			add_location(h10, file, 99, 4, 2792);
			attr_dev(div0, "class", "projectTitle svelte-1a75a7r");
			add_location(div0, file, 98, 3, 2761);
			attr_dev(p0, "class", "svelte-1a75a7r");
			add_location(p0, file, 102, 4, 2859);
			attr_dev(p1, "class", "svelte-1a75a7r");
			add_location(p1, file, 105, 4, 2935);
			attr_dev(div1, "class", "projectBody svelte-1a75a7r");
			add_location(div1, file, 101, 3, 2829);
			attr_dev(div2, "class", "svelte-1a75a7r");
			add_location(div2, file, 97, 2, 2752);
			attr_dev(a0, "class", "projectTile svelte-1a75a7r");
			attr_dev(a0, "href", "This Website");
			attr_dev(a0, "onclick", "return false");
			attr_dev(a0, "target", "_blank");
			add_location(a0, file, 91, 1, 2657);
			attr_dev(h11, "class", "svelte-1a75a7r");
			add_location(h11, file, 116, 4, 3175);
			attr_dev(div3, "class", "projectTitle svelte-1a75a7r");
			add_location(div3, file, 115, 3, 3144);
			attr_dev(p2, "class", "svelte-1a75a7r");
			add_location(p2, file, 119, 4, 3234);
			attr_dev(p3, "class", "svelte-1a75a7r");
			add_location(p3, file, 122, 4, 3279);
			attr_dev(p4, "class", "svelte-1a75a7r");
			add_location(p4, file, 126, 4, 3417);
			attr_dev(div4, "class", "projectBody svelte-1a75a7r");
			add_location(div4, file, 118, 3, 3204);
			attr_dev(div5, "class", "projectTile svelte-1a75a7r");
			add_location(div5, file, 114, 2, 3115);
			attr_dev(a1, "href", "https://coopscodes.github.io/resume/");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-1a75a7r");
			add_location(a1, file, 113, 1, 3049);
			attr_dev(h12, "class", "svelte-1a75a7r");
			add_location(h12, file, 136, 4, 3613);
			attr_dev(div6, "class", "projectTitle svelte-1a75a7r");
			add_location(div6, file, 135, 3, 3582);
			attr_dev(p5, "class", "svelte-1a75a7r");
			add_location(p5, file, 139, 4, 3692);
			attr_dev(p6, "class", "svelte-1a75a7r");
			add_location(p6, file, 146, 4, 3906);
			attr_dev(div7, "class", "projectBody svelte-1a75a7r");
			add_location(div7, file, 138, 3, 3662);
			attr_dev(div8, "class", "projectTile svelte-1a75a7r");
			add_location(div8, file, 134, 2, 3553);
			attr_dev(a2, "href", "https://github.com/CoopsCodes/CSharpRobot");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-1a75a7r");
			add_location(a2, file, 133, 1, 3482);
			attr_dev(h13, "class", "svelte-1a75a7r");
			add_location(h13, file, 156, 4, 4099);
			attr_dev(div9, "class", "projectTitle svelte-1a75a7r");
			add_location(div9, file, 155, 3, 4068);
			attr_dev(p7, "class", "svelte-1a75a7r");
			add_location(p7, file, 159, 4, 4164);
			attr_dev(p8, "class", "svelte-1a75a7r");
			add_location(p8, file, 162, 4, 4239);
			attr_dev(p9, "class", "svelte-1a75a7r");
			add_location(p9, file, 165, 4, 4306);
			attr_dev(div10, "class", "projectBody svelte-1a75a7r");
			add_location(div10, file, 158, 3, 4134);
			attr_dev(div11, "class", "projectTile svelte-1a75a7r");
			add_location(div11, file, 154, 2, 4039);
			attr_dev(a3, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-1a75a7r");
			add_location(a3, file, 153, 1, 3966);
			attr_dev(h14, "class", "svelte-1a75a7r");
			add_location(h14, file, 175, 4, 4492);
			attr_dev(div12, "class", "projectTitle svelte-1a75a7r");
			add_location(div12, file, 174, 3, 4461);
			attr_dev(p10, "class", "svelte-1a75a7r");
			add_location(p10, file, 178, 4, 4551);
			attr_dev(p11, "class", "svelte-1a75a7r");
			add_location(p11, file, 182, 4, 4681);
			attr_dev(div13, "class", "projectBody svelte-1a75a7r");
			add_location(div13, file, 177, 3, 4521);
			attr_dev(div14, "class", "projectTile svelte-1a75a7r");
			add_location(div14, file, 173, 2, 4432);
			attr_dev(a4, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-1a75a7r");
			add_location(a4, file, 172, 1, 4366);
			attr_dev(h15, "class", "svelte-1a75a7r");
			add_location(h15, file, 195, 4, 4898);
			attr_dev(div15, "class", "projectTitle svelte-1a75a7r");
			add_location(div15, file, 194, 3, 4867);
			attr_dev(p12, "class", "svelte-1a75a7r");
			add_location(p12, file, 198, 4, 4982);
			attr_dev(p13, "class", "svelte-1a75a7r");
			add_location(p13, file, 202, 4, 5088);
			attr_dev(div16, "class", "projectBody svelte-1a75a7r");
			add_location(div16, file, 197, 3, 4952);
			attr_dev(div17, "class", "projectTile svelte-1a75a7r");
			add_location(div17, file, 193, 2, 4838);
			attr_dev(a5, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a5, "target", "_blank");
			attr_dev(a5, "class", "svelte-1a75a7r");
			add_location(a5, file, 189, 1, 4741);
			attr_dev(body, "class", "projectsContainer svelte-1a75a7r");
			add_location(body, file, 69, 0, 2134);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
