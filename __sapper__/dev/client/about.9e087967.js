import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, o as onMount, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, p as binding_callbacks, r as globals } from './client.b6cc2055.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(canvas_1, "class", "svelte-kny1bh");
			add_location(canvas_1, file, 236, 1, 4832);
			attr_dev(h10, "class", "svelte-kny1bh");
			add_location(h10, file, 239, 24, 4955);
			attr_dev(div0, "class", "aboutMe svelte-kny1bh");
			add_location(div0, file, 239, 3, 4934);
			attr_dev(div1, "class", "columnOne svelte-kny1bh");
			add_location(div1, file, 238, 2, 4907);
			attr_dev(h11, "class", "svelte-kny1bh");
			add_location(h11, file, 242, 23, 5037);
			attr_dev(div2, "class", "skills svelte-kny1bh");
			add_location(div2, file, 242, 3, 5017);
			attr_dev(h12, "class", "svelte-kny1bh");
			add_location(h12, file, 243, 24, 5083);
			attr_dev(div3, "class", "socials svelte-kny1bh");
			add_location(div3, file, 243, 3, 5062);
			attr_dev(div4, "class", "columnTwo svelte-kny1bh");
			add_location(div4, file, 241, 2, 4990);
			attr_dev(div5, "class", "parent svelte-kny1bh");
			add_location(div5, file, 237, 1, 4884);
			attr_dev(body, "class", "aboutContainer svelte-kny1bh");
			add_location(body, file, 235, 0, 4801);
		},
