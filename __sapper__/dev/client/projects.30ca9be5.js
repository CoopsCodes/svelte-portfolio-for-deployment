...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-17jj9mu");
			add_location(h10, file, 64, 8, 1872);
			attr_dev(div0, "class", "projectTitle svelte-17jj9mu");
			add_location(div0, file, 63, 6, 1837);
			attr_dev(p0, "class", "svelte-17jj9mu");
			add_location(p0, file, 67, 8, 1951);
			attr_dev(p1, "class", "svelte-17jj9mu");
			add_location(p1, file, 70, 8, 2004);
			attr_dev(p2, "class", "svelte-17jj9mu");
			add_location(p2, file, 73, 8, 2092);
			attr_dev(div1, "class", "projectBody svelte-17jj9mu");
			add_location(div1, file, 66, 6, 1917);
			attr_dev(div2, "class", "projectTile svelte-17jj9mu");
			add_location(div2, file, 62, 4, 1805);
			attr_dev(a0, "href", "https://cooper-codes.dev/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-17jj9mu");
			add_location(a0, file, 61, 2, 1748);
			attr_dev(h11, "class", "svelte-17jj9mu");
			add_location(h11, file, 83, 8, 2307);
			attr_dev(div3, "class", "projectTitle svelte-17jj9mu");
			add_location(div3, file, 82, 6, 2272);
			attr_dev(p3, "class", "svelte-17jj9mu");
			add_location(p3, file, 86, 8, 2382);
			attr_dev(div4, "class", "projectBody svelte-17jj9mu");
			add_location(div4, file, 85, 6, 2348);
			attr_dev(div5, "class", "projectTile svelte-17jj9mu");
			add_location(div5, file, 81, 4, 2240);
			attr_dev(a1, "href", "This Website");
			attr_dev(a1, "onclick", "return false");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-17jj9mu");
			add_location(a1, file, 80, 2, 2173);
			attr_dev(h12, "class", "svelte-17jj9mu");
			add_location(h12, file, 96, 8, 2656);
			attr_dev(div6, "class", "projectTitle svelte-17jj9mu");
			add_location(div6, file, 95, 6, 2621);
			attr_dev(p4, "class", "svelte-17jj9mu");
			add_location(p4, file, 99, 8, 2731);
			attr_dev(p5, "class", "svelte-17jj9mu");
			add_location(p5, file, 102, 8, 2819);
			attr_dev(p6, "class", "svelte-17jj9mu");
			add_location(p6, file, 105, 8, 2899);
			attr_dev(div7, "class", "projectBody svelte-17jj9mu");
			add_location(div7, file, 98, 6, 2697);
			attr_dev(div8, "class", "projectTile svelte-17jj9mu");
			add_location(div8, file, 94, 4, 2589);
			attr_dev(a2, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-17jj9mu");
			add_location(a2, file, 93, 2, 2514);
			attr_dev(h13, "class", "svelte-17jj9mu");
			add_location(h13, file, 115, 8, 3115);
			attr_dev(div9, "class", "projectTitle svelte-17jj9mu");
			add_location(div9, file, 114, 6, 3080);
			attr_dev(p7, "class", "svelte-17jj9mu");
			add_location(p7, file, 118, 8, 3184);
			attr_dev(p8, "class", "svelte-17jj9mu");
			add_location(p8, file, 122, 8, 3332);
			attr_dev(div10, "class", "projectBody svelte-17jj9mu");
			add_location(div10, file, 117, 6, 3150);
			attr_dev(div11, "class", "projectTile svelte-17jj9mu");
			add_location(div11, file, 113, 4, 3048);
			attr_dev(a3, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-17jj9mu");
			add_location(a3, file, 112, 2, 2980);
			attr_dev(h14, "class", "svelte-17jj9mu");
			add_location(h14, file, 135, 8, 3584);
			attr_dev(div12, "class", "projectTitle svelte-17jj9mu");
			add_location(div12, file, 134, 6, 3549);
			attr_dev(p9, "class", "svelte-17jj9mu");
			add_location(p9, file, 138, 8, 3678);
			attr_dev(p10, "class", "svelte-17jj9mu");
			add_location(p10, file, 142, 8, 3802);
			attr_dev(div13, "class", "projectBody svelte-17jj9mu");
			add_location(div13, file, 137, 6, 3644);
			attr_dev(div14, "class", "projectTile svelte-17jj9mu");
			add_location(div14, file, 133, 4, 3517);
			attr_dev(a4, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-17jj9mu");
			add_location(a4, file, 129, 2, 3413);
			attr_dev(body, "class", "projectsContainer svelte-17jj9mu");
			add_location(body, file, 60, 0, 1713);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
