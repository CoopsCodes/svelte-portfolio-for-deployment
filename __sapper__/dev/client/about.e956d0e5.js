...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(canvas_1, "class", "svelte-1mdpn7w");
			add_location(canvas_1, file, 201, 1, 4324);
			attr_dev(body, "class", "aboutContainer svelte-1mdpn7w");
			add_location(body, file, 200, 0, 4293);
		},
