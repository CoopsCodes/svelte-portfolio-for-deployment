...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-147dm9m");
			add_location(h10, file, 88, 4, 2511);
			attr_dev(div0, "class", "projectTitle svelte-147dm9m");
			add_location(div0, file, 87, 3, 2480);
			attr_dev(p0, "class", "svelte-147dm9m");
			add_location(p0, file, 91, 4, 2576);
			attr_dev(p1, "class", "svelte-147dm9m");
			add_location(p1, file, 94, 4, 2658);
			attr_dev(div1, "class", "projectBody svelte-147dm9m");
			add_location(div1, file, 90, 3, 2546);
			attr_dev(div2, "class", "projectTile svelte-147dm9m");
			add_location(div2, file, 86, 2, 2451);
			attr_dev(a0, "href", "This Website");
			attr_dev(a0, "onclick", "return false");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-147dm9m");
			add_location(a0, file, 85, 1, 2386);
			attr_dev(h11, "class", "svelte-147dm9m");
			add_location(h11, file, 105, 4, 2898);
			attr_dev(div3, "class", "projectTitle svelte-147dm9m");
			add_location(div3, file, 104, 3, 2867);
			attr_dev(p2, "class", "svelte-147dm9m");
			add_location(p2, file, 108, 4, 2957);
			attr_dev(p3, "class", "svelte-147dm9m");
			add_location(p3, file, 111, 4, 3002);
			attr_dev(p4, "class", "svelte-147dm9m");
			add_location(p4, file, 115, 4, 3140);
			attr_dev(div4, "class", "projectBody svelte-147dm9m");
			add_location(div4, file, 107, 3, 2927);
			attr_dev(div5, "class", "projectTile svelte-147dm9m");
			add_location(div5, file, 103, 2, 2838);
			attr_dev(a1, "href", "https://coopscodes.github.io/resume/");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-147dm9m");
			add_location(a1, file, 102, 1, 2772);
			attr_dev(h12, "class", "svelte-147dm9m");
			add_location(h12, file, 125, 4, 3336);
			attr_dev(div6, "class", "projectTitle svelte-147dm9m");
			add_location(div6, file, 124, 3, 3305);
			attr_dev(p5, "class", "svelte-147dm9m");
			add_location(p5, file, 128, 4, 3415);
			attr_dev(p6, "class", "svelte-147dm9m");
			add_location(p6, file, 135, 4, 3629);
			attr_dev(div7, "class", "projectBody svelte-147dm9m");
			add_location(div7, file, 127, 3, 3385);
			attr_dev(div8, "class", "projectTile svelte-147dm9m");
			add_location(div8, file, 123, 2, 3276);
			attr_dev(a2, "href", "https://github.com/CoopsCodes/CSharpRobot");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-147dm9m");
			add_location(a2, file, 122, 1, 3205);
			attr_dev(h13, "class", "svelte-147dm9m");
			add_location(h13, file, 145, 4, 3822);
			attr_dev(div9, "class", "projectTitle svelte-147dm9m");
			add_location(div9, file, 144, 3, 3791);
			attr_dev(p7, "class", "svelte-147dm9m");
			add_location(p7, file, 148, 4, 3887);
			attr_dev(p8, "class", "svelte-147dm9m");
			add_location(p8, file, 151, 4, 3962);
			attr_dev(p9, "class", "svelte-147dm9m");
			add_location(p9, file, 154, 4, 4029);
			attr_dev(div10, "class", "projectBody svelte-147dm9m");
			add_location(div10, file, 147, 3, 3857);
			attr_dev(div11, "class", "projectTile svelte-147dm9m");
			add_location(div11, file, 143, 2, 3762);
			attr_dev(a3, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-147dm9m");
			add_location(a3, file, 142, 1, 3689);
			attr_dev(h14, "class", "svelte-147dm9m");
			add_location(h14, file, 164, 4, 4215);
			attr_dev(div12, "class", "projectTitle svelte-147dm9m");
			add_location(div12, file, 163, 3, 4184);
			attr_dev(p10, "class", "svelte-147dm9m");
			add_location(p10, file, 167, 4, 4274);
			attr_dev(p11, "class", "svelte-147dm9m");
			add_location(p11, file, 171, 4, 4404);
			attr_dev(div13, "class", "projectBody svelte-147dm9m");
			add_location(div13, file, 166, 3, 4244);
			attr_dev(div14, "class", "projectTile svelte-147dm9m");
			add_location(div14, file, 162, 2, 4155);
			attr_dev(a4, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-147dm9m");
			add_location(a4, file, 161, 1, 4089);
			attr_dev(h15, "class", "svelte-147dm9m");
			add_location(h15, file, 184, 4, 4621);
			attr_dev(div15, "class", "projectTitle svelte-147dm9m");
			add_location(div15, file, 183, 3, 4590);
			attr_dev(p12, "class", "svelte-147dm9m");
			add_location(p12, file, 187, 4, 4705);
			attr_dev(p13, "class", "svelte-147dm9m");
			add_location(p13, file, 191, 4, 4811);
			attr_dev(div16, "class", "projectBody svelte-147dm9m");
			add_location(div16, file, 186, 3, 4675);
			attr_dev(div17, "class", "projectTile svelte-147dm9m");
			add_location(div17, file, 182, 2, 4561);
			attr_dev(a5, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a5, "target", "_blank");
			attr_dev(a5, "class", "svelte-147dm9m");
			add_location(a5, file, 178, 1, 4464);
			attr_dev(body, "class", "projectsContainer svelte-147dm9m");
			add_location(body, file, 63, 0, 1863);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
