...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-1cnfhd1");
			add_location(h10, file, 93, 4, 2744);
			attr_dev(div0, "class", "projectTitle svelte-1cnfhd1");
			add_location(div0, file, 92, 3, 2713);
			attr_dev(p0, "class", "svelte-1cnfhd1");
			add_location(p0, file, 96, 4, 2811);
			attr_dev(p1, "class", "svelte-1cnfhd1");
			add_location(p1, file, 99, 4, 2887);
			attr_dev(div1, "class", "projectBody svelte-1cnfhd1");
			add_location(div1, file, 95, 3, 2781);
			attr_dev(div2, "class", "projectTile svelte-1cnfhd1");
			add_location(div2, file, 91, 2, 2684);
			attr_dev(a0, "href", "This Website");
			attr_dev(a0, "onclick", "return false");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-1cnfhd1");
			add_location(a0, file, 90, 1, 2619);
			attr_dev(h11, "class", "svelte-1cnfhd1");
			add_location(h11, file, 110, 4, 3127);
			attr_dev(div3, "class", "projectTitle svelte-1cnfhd1");
			add_location(div3, file, 109, 3, 3096);
			attr_dev(p2, "class", "svelte-1cnfhd1");
			add_location(p2, file, 113, 4, 3186);
			attr_dev(p3, "class", "svelte-1cnfhd1");
			add_location(p3, file, 116, 4, 3231);
			attr_dev(p4, "class", "svelte-1cnfhd1");
			add_location(p4, file, 120, 4, 3369);
			attr_dev(div4, "class", "projectBody svelte-1cnfhd1");
			add_location(div4, file, 112, 3, 3156);
			attr_dev(div5, "class", "projectTile svelte-1cnfhd1");
			add_location(div5, file, 108, 2, 3067);
			attr_dev(a1, "href", "https://coopscodes.github.io/resume/");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-1cnfhd1");
			add_location(a1, file, 107, 1, 3001);
			attr_dev(h12, "class", "svelte-1cnfhd1");
			add_location(h12, file, 130, 4, 3565);
			attr_dev(div6, "class", "projectTitle svelte-1cnfhd1");
			add_location(div6, file, 129, 3, 3534);
			attr_dev(p5, "class", "svelte-1cnfhd1");
			add_location(p5, file, 133, 4, 3644);
			attr_dev(p6, "class", "svelte-1cnfhd1");
			add_location(p6, file, 140, 4, 3858);
			attr_dev(div7, "class", "projectBody svelte-1cnfhd1");
			add_location(div7, file, 132, 3, 3614);
			attr_dev(div8, "class", "projectTile svelte-1cnfhd1");
			add_location(div8, file, 128, 2, 3505);
			attr_dev(a2, "href", "https://github.com/CoopsCodes/CSharpRobot");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-1cnfhd1");
			add_location(a2, file, 127, 1, 3434);
			attr_dev(h13, "class", "svelte-1cnfhd1");
			add_location(h13, file, 150, 4, 4051);
			attr_dev(div9, "class", "projectTitle svelte-1cnfhd1");
			add_location(div9, file, 149, 3, 4020);
			attr_dev(p7, "class", "svelte-1cnfhd1");
			add_location(p7, file, 153, 4, 4116);
			attr_dev(p8, "class", "svelte-1cnfhd1");
			add_location(p8, file, 156, 4, 4191);
			attr_dev(p9, "class", "svelte-1cnfhd1");
			add_location(p9, file, 159, 4, 4258);
			attr_dev(div10, "class", "projectBody svelte-1cnfhd1");
			add_location(div10, file, 152, 3, 4086);
			attr_dev(div11, "class", "projectTile svelte-1cnfhd1");
			add_location(div11, file, 148, 2, 3991);
			attr_dev(a3, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-1cnfhd1");
			add_location(a3, file, 147, 1, 3918);
			attr_dev(h14, "class", "svelte-1cnfhd1");
			add_location(h14, file, 169, 4, 4444);
			attr_dev(div12, "class", "projectTitle svelte-1cnfhd1");
			add_location(div12, file, 168, 3, 4413);
			attr_dev(p10, "class", "svelte-1cnfhd1");
			add_location(p10, file, 172, 4, 4503);
			attr_dev(p11, "class", "svelte-1cnfhd1");
			add_location(p11, file, 176, 4, 4633);
			attr_dev(div13, "class", "projectBody svelte-1cnfhd1");
			add_location(div13, file, 171, 3, 4473);
			attr_dev(div14, "class", "projectTile svelte-1cnfhd1");
			add_location(div14, file, 167, 2, 4384);
			attr_dev(a4, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-1cnfhd1");
			add_location(a4, file, 166, 1, 4318);
			attr_dev(h15, "class", "svelte-1cnfhd1");
			add_location(h15, file, 189, 4, 4850);
			attr_dev(div15, "class", "projectTitle svelte-1cnfhd1");
			add_location(div15, file, 188, 3, 4819);
			attr_dev(p12, "class", "svelte-1cnfhd1");
			add_location(p12, file, 192, 4, 4934);
			attr_dev(p13, "class", "svelte-1cnfhd1");
			add_location(p13, file, 196, 4, 5040);
			attr_dev(div16, "class", "projectBody svelte-1cnfhd1");
			add_location(div16, file, 191, 3, 4904);
			attr_dev(div17, "class", "projectTile svelte-1cnfhd1");
			add_location(div17, file, 187, 2, 4790);
			attr_dev(a5, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a5, "target", "_blank");
			attr_dev(a5, "class", "svelte-1cnfhd1");
			add_location(a5, file, 183, 1, 4693);
			attr_dev(body, "class", "projectsContainer svelte-1cnfhd1");
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
