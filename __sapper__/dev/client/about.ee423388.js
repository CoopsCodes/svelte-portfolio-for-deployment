import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, o as onMount, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, p as binding_callbacks, r as globals } from './client.273f5470.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(canvas_1, "class", "svelte-115onm4");
			add_location(canvas_1, file, 212, 1, 4471);
			attr_dev(div0, "class", "background svelte-115onm4");
			add_location(div0, file, 213, 1, 4523);
			attr_dev(p0, "class", "svelte-115onm4");
			add_location(p0, file, 215, 2, 4576);
			attr_dev(p1, "class", "svelte-115onm4");
			add_location(p1, file, 216, 2, 4598);
			attr_dev(p2, "class", "svelte-115onm4");
			add_location(p2, file, 220, 2, 4697);
			attr_dev(p3, "class", "svelte-115onm4");
			add_location(p3, file, 225, 2, 4905);
			attr_dev(p4, "class", "svelte-115onm4");
			add_location(p4, file, 230, 2, 5084);
			attr_dev(p5, "class", "svelte-115onm4");
			add_location(p5, file, 236, 2, 5374);
			attr_dev(p6, "class", "svelte-115onm4");
			add_location(p6, file, 241, 2, 5567);
			attr_dev(div1, "class", "main svelte-115onm4");
			add_location(div1, file, 214, 1, 4555);
			attr_dev(body, "class", "svelte-115onm4");
			add_location(body, file, 211, 0, 4463);
		},
