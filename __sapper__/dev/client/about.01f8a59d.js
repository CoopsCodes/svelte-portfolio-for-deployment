import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, o as onMount, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, p as binding_callbacks, r as globals } from './client.669cb19e.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(canvas_1, "class", "svelte-l5f64c");
			add_location(canvas_1, file, 214, 1, 4535);
			attr_dev(div0, "class", "background svelte-l5f64c");
			add_location(div0, file, 215, 1, 4587);
			attr_dev(p0, "class", "svelte-l5f64c");
			add_location(p0, file, 217, 2, 4640);
			attr_dev(p1, "class", "svelte-l5f64c");
			add_location(p1, file, 218, 2, 4662);
			attr_dev(p2, "class", "svelte-l5f64c");
			add_location(p2, file, 222, 2, 4761);
			attr_dev(p3, "class", "svelte-l5f64c");
			add_location(p3, file, 227, 2, 4969);
			attr_dev(p4, "class", "svelte-l5f64c");
			add_location(p4, file, 232, 2, 5148);
			attr_dev(p5, "class", "svelte-l5f64c");
			add_location(p5, file, 238, 2, 5438);
			attr_dev(p6, "class", "svelte-l5f64c");
			add_location(p6, file, 243, 2, 5631);
			attr_dev(div1, "class", "main svelte-l5f64c");
			add_location(div1, file, 216, 1, 4619);
			attr_dev(body, "class", "svelte-l5f64c");
