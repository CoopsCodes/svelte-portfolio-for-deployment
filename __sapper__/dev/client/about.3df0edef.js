import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, o as onMount, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, p as binding_callbacks, r as globals } from './client.a4699aec.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			t4 = space();
			h10 = element("h1");
			t5 = text("This sexy page is coming soon.");
			t6 = space();
			h11 = element("h1");
			t7 = text("Soon this will tell you about me");
			this.h();
		},
		l: function claim(nodes) {
			...
			t5 = claim_text(h10_nodes, "This sexy page is coming soon.");
			h10_nodes.forEach(detach_dev);
			t6 = claim_space(body_nodes);
			h11 = claim_element(body_nodes, "H1", { class: true });
			var h11_nodes = children(h11);
			t7 = claim_text(h11_nodes, "Soon this will tell you about me");
		...
		h: function hydrate() {
			...
			add_location(h11, file, 196, 1, 4195);
