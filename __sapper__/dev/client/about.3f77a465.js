...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(canvas_1, "class", "svelte-pg91xg");
			add_location(canvas_1, file, 201, 1, 4309);
			attr_dev(body, "class", "aboutContainer svelte-pg91xg");
			add_location(body, file, 200, 0, 4278);
		},
