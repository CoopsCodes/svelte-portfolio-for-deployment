import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, o as onMount, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, p as binding_callbacks, r as globals } from './client.de07ece9.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			t3 = space();
			h11 = element("h1");
			t4 = text("This sexy page is coming soon.");
			t5 = space();
			h12 = element("h1");
			t6 = text("Soon this will tell you about me");
			this.h();
		},
		l: function claim(nodes) {
			...
			t4 = claim_text(h11_nodes, "This sexy page is coming soon.");
			h11_nodes.forEach(detach_dev);
			t5 = claim_space(body_nodes);
			h12 = claim_element(body_nodes, "H1", { class: true });
			var h12_nodes = children(h12);
			t6 = claim_text(h12_nodes, "Soon this will tell you about me");
		...
		h: function hydrate() {
			...
			add_location(h11, file, 193, 1, 4147);
			attr_dev(h12, "class", "svelte-ogczsn");
			add_location(h12, file, 194, 1, 4188);
