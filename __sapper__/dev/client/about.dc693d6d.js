import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, o as onMount, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, p as binding_callbacks, r as globals } from './client.e6eca981.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(canvas_1, "class", "svelte-v0jg2q");
			add_location(canvas_1, file, 220, 1, 4640);
			attr_dev(div0, "class", "main svelte-v0jg2q");
			add_location(div0, file, 222, 2, 4723);
			attr_dev(div1, "class", "socials svelte-v0jg2q");
			add_location(div1, file, 223, 2, 4758);
			attr_dev(div2, "class", "skills svelte-v0jg2q");
			add_location(div2, file, 224, 2, 4795);
			attr_dev(div3, "class", "grid-container svelte-v0jg2q");
			add_location(div3, file, 221, 1, 4692);
			attr_dev(body, "class", "aboutContainer svelte-v0jg2q");
