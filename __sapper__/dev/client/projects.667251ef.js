...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h10, "class", "svelte-1l2ywl1");
			add_location(h10, file, 70, 8, 2104);
			attr_dev(div0, "class", "projectTitle svelte-1l2ywl1");
			add_location(div0, file, 69, 6, 2069);
			attr_dev(p0, "class", "svelte-1l2ywl1");
			add_location(p0, file, 73, 8, 2183);
			attr_dev(p1, "class", "svelte-1l2ywl1");
			add_location(p1, file, 76, 8, 2236);
			attr_dev(p2, "class", "svelte-1l2ywl1");
			add_location(p2, file, 79, 8, 2324);
			attr_dev(div1, "class", "projectBody svelte-1l2ywl1");
			add_location(div1, file, 72, 6, 2149);
			attr_dev(div2, "class", "projectTile svelte-1l2ywl1");
			add_location(div2, file, 68, 4, 2037);
			attr_dev(a0, "href", "https://cooper-codes.dev/");
			attr_dev(a0, "target", "_blank");
			attr_dev(a0, "class", "svelte-1l2ywl1");
			add_location(a0, file, 67, 2, 1980);
			attr_dev(h11, "class", "svelte-1l2ywl1");
			add_location(h11, file, 89, 8, 2539);
			attr_dev(div3, "class", "projectTitle svelte-1l2ywl1");
			add_location(div3, file, 88, 6, 2504);
			attr_dev(p3, "class", "svelte-1l2ywl1");
			add_location(p3, file, 92, 8, 2614);
			attr_dev(div4, "class", "projectBody svelte-1l2ywl1");
			add_location(div4, file, 91, 6, 2580);
			attr_dev(div5, "class", "projectTile svelte-1l2ywl1");
			add_location(div5, file, 87, 4, 2472);
			attr_dev(a1, "href", "This Website");
			attr_dev(a1, "onclick", "return false");
			attr_dev(a1, "target", "_blank");
			attr_dev(a1, "class", "svelte-1l2ywl1");
			add_location(a1, file, 86, 2, 2405);
			attr_dev(h12, "class", "svelte-1l2ywl1");
			add_location(h12, file, 102, 8, 2888);
			attr_dev(div6, "class", "projectTitle svelte-1l2ywl1");
			add_location(div6, file, 101, 6, 2853);
			attr_dev(p4, "class", "svelte-1l2ywl1");
			add_location(p4, file, 105, 8, 2963);
			attr_dev(p5, "class", "svelte-1l2ywl1");
			add_location(p5, file, 108, 8, 3051);
			attr_dev(p6, "class", "svelte-1l2ywl1");
			add_location(p6, file, 111, 8, 3131);
			attr_dev(div7, "class", "projectBody svelte-1l2ywl1");
			add_location(div7, file, 104, 6, 2929);
			attr_dev(div8, "class", "projectTile svelte-1l2ywl1");
			add_location(div8, file, 100, 4, 2821);
			attr_dev(a2, "href", "https://coopscodes.github.io/that-cat-page/");
			attr_dev(a2, "target", "_blank");
			attr_dev(a2, "class", "svelte-1l2ywl1");
			add_location(a2, file, 99, 2, 2746);
			attr_dev(h13, "class", "svelte-1l2ywl1");
			add_location(h13, file, 121, 8, 3347);
			attr_dev(div9, "class", "projectTitle svelte-1l2ywl1");
			add_location(div9, file, 120, 6, 3312);
			attr_dev(p7, "class", "svelte-1l2ywl1");
			add_location(p7, file, 124, 8, 3416);
			attr_dev(p8, "class", "svelte-1l2ywl1");
			add_location(p8, file, 128, 8, 3564);
			attr_dev(div10, "class", "projectBody svelte-1l2ywl1");
			add_location(div10, file, 123, 6, 3382);
			attr_dev(div11, "class", "projectTile svelte-1l2ywl1");
			add_location(div11, file, 119, 4, 3280);
			attr_dev(a3, "href", "https://coopscodes.github.io/Tetris/");
			attr_dev(a3, "target", "_blank");
			attr_dev(a3, "class", "svelte-1l2ywl1");
			add_location(a3, file, 118, 2, 3212);
			attr_dev(h14, "class", "svelte-1l2ywl1");
			add_location(h14, file, 141, 8, 3816);
			attr_dev(div12, "class", "projectTitle svelte-1l2ywl1");
			add_location(div12, file, 140, 6, 3781);
			attr_dev(p9, "class", "svelte-1l2ywl1");
			add_location(p9, file, 144, 8, 3910);
			attr_dev(p10, "class", "svelte-1l2ywl1");
			add_location(p10, file, 148, 8, 4034);
			attr_dev(div13, "class", "projectBody svelte-1l2ywl1");
			add_location(div13, file, 143, 6, 3876);
			attr_dev(div14, "class", "projectTile svelte-1l2ywl1");
			add_location(div14, file, 139, 4, 3749);
			attr_dev(a4, "href", "https://coopscodes.github.io/Compounding-Interest-Calculator/");
			attr_dev(a4, "target", "_blank");
			attr_dev(a4, "class", "svelte-1l2ywl1");
			add_location(a4, file, 135, 2, 3645);
			attr_dev(body, "class", "projectsContainer svelte-1l2ywl1");
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
