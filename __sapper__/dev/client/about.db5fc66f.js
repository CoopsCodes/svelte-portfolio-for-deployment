import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, o as onMount, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, p as binding_callbacks, r as globals } from './client.07e50fb1.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(canvas_1, "class", "svelte-aoarat");
			add_location(canvas_1, file, 219, 1, 4702);
			attr_dev(div0, "class", "background svelte-aoarat");
			add_location(div0, file, 220, 1, 4754);
			attr_dev(p0, "class", "svelte-aoarat");
			add_location(p0, file, 222, 2, 4807);
			attr_dev(p1, "class", "svelte-aoarat");
			add_location(p1, file, 223, 2, 4829);
			attr_dev(p2, "class", "svelte-aoarat");
			add_location(p2, file, 227, 2, 4928);
			attr_dev(p3, "class", "svelte-aoarat");
			add_location(p3, file, 232, 2, 5136);
			attr_dev(p4, "class", "svelte-aoarat");
			add_location(p4, file, 237, 2, 5315);
			attr_dev(p5, "class", "svelte-aoarat");
			add_location(p5, file, 243, 2, 5605);
			attr_dev(p6, "class", "svelte-aoarat");
			add_location(p6, file, 248, 2, 5798);
			attr_dev(div1, "class", "main svelte-aoarat");
			add_location(div1, file, 221, 1, 4786);
			attr_dev(body, "class", "svelte-aoarat");
			add_location(body, file, 218, 0, 4694);
		},
